...
class DeleteDiseasesVC: UIViewController {
    ...
    var id: Int = 0
    var Delegete: DeleteDiseases?
    override func viewDidLoad() {
        super.viewDidLoad()
        self.AddBlurEffect(BlurView: self.blurView)
            addressLbl.text = "Are you want to Delete this disease ?".localized
        titleLbl.text = "Delete disease".localized
        ...
        NetworkClient.performRequest(_type: SuccessModel.self, router: .deleteDieses(Id: Id)) { (result) in
            ...
            case .success(let model):
                if model.successtate == 200{
                    ...
                    self.showMessage(sub: "Disease has been removed from list".localized)

...
struct ConsultationLogModel : Codable {
    let successtate : Int?
    let errormessage : String?
    let message : [ConsultationLogData]?
    ...
    init(from decoder: Decoder) throws {
        ...
        message = try values.decodeIfPresent([ConsultationLogData].self, forKey: .message)
    }

}
struct ConsultationLogData : Codable {
    let bookingId : Int?
...
struct AvilableButtonsForDoctor : Codable {
    let enterConfirmationCode : Bool?
    ...
    let enterConfirmationCode_Localized : String?

    enum CodingKeys: String, CodingKey {

        case enterConfirmationCode = "enterConfirmationCode"
        ...
        case enterConfirmationCode_Localized = "enterConfirmationCode_Localized"
    }

    init(from decoder: Decoder) throws {
        let values = try decoder.container(keyedBy: CodingKeys.self)
        enterConfirmationCode = try values.decodeIfPresent(Bool.self, forKey: .enterConfirmationCode)
        ...
        enterConfirmationCode_Localized = try values.decodeIfPresent(String.self, forKey: .enterConfirmationCode_Localized)
    }

}
struct AvilableButtonsForPatient : Codable {
    let enterConfirmationCode : Bool?
    let acceptOrConfirm : Bool?
    let acceptOrConfirm_Localized : String?
    let cancel : Bool?
...
struct BookingAvilableButtons : Codable {
    let avilableButtonsForDoctor : AvilableButtonsForDoctor?
    let avilableButtonsForPatient : AvilableButtonsForPatient?
    ...
    init(from decoder: Decoder) throws {
        let values = try decoder.container(keyedBy: CodingKeys.self)
        avilableButtonsForDoctor = try values.decodeIfPresent(AvilableButtonsForDoctor.self, forKey: .avilableButtonsForDoctor)
        avilableButtonsForPatient = try values.decodeIfPresent(AvilableButtonsForPatient.self, forKey: .avilableButtonsForPatient)
    }
...
//        patientReviewComplaint = try values.decodeIfPresent([String].self, forKey: .patientReviewComplaint)

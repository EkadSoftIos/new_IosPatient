...
class DeleteSurgeyVC: UIViewController {
    ...
    var id: Int = 0
    var Delegete: DeleteSurgey?
    override func viewDidLoad() {
        super.viewDidLoad()
        self.AddBlurEffect(BlurView: self.blurView)
            addressLbl.text = "Are you want to Delete this surgey ?".localized
        titleLbl.text = "Delete Surgey".localized
    ...
    func callApiDelete(Id: Int){
        ...
        NetworkClient.performRequest(_type: SuccessModel.self, router: .deleteSurgery(id: Id)) { (result) in
            ...
            case .success(let model):
                if model.successtate == 200{
                    ...
                    self.showMessage(title: "", sub: "Surgery has been removed from list".localized, type: .success, layout: .messageView)
                }else{

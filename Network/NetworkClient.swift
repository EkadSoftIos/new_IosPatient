...
//        var headers: [String: String] = ["Content-Type":"application/json", "lang": "2"]
        ...
        AF.request(URL(string: router.path)!, method: router.method, parameters: router.parameters, encoding: JSONEncoding.default, headers: headers).responseJSON { (response) in
